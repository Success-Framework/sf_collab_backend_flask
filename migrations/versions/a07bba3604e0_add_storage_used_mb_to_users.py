...
def upgrade():
    ...
    # Added nullable=True to be safe or you can add server_default='0'
    ...
    # Added nullable=True to be safe
    ...
    # CRITICAL FIX: Added server_default='0' for the column that was failing
