...
CREATE TABLE `ai_news_articles` (
  ...
  `is_active` tinyint(1) DEFAULT 1,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_ai_news_url` (`url`(255)),
  KEY `idx_ai_news_source` (`source`),
  KEY `idx_ai_news_category` (`category`),
  KEY `idx_ai_news_published_at` (`published_at`),
  KEY `idx_ai_news_is_active` (`is_active`),
  KEY `idx_ai_news_impact_score` (`impact_score`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
